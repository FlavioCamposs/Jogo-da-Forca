## Este código é um jogo da forca em Python. Ele permite que o jogador escolha um tema (como animais, países, filmes, séries, etc.) e tenta adivinhar a palavra oculta escolhida aleatoriamente pelo programa. Abaixo, vou explicar cada parte do código:
...
Lembre-se de que, para executar esse código, você precisará ter o Python instalado em seu ambiente e também as bibliotecas random e unidecode. 
